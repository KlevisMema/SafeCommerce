...
public class Mapper_Shop : Profile
{
    public Mapper_Shop()
    {
        CreateMap<SafeCommerce.DataAccessLayer.Models.Shop, DTO_Shop>()
        ...
        CreateMap<SafeCommerce.DataAccessLayer.Models.Shop, DTO_ShopForModeration>()
            .ForMember(dest => dest.OwnerName, opt => opt.MapFrom(src => src.Owner.UserName))
        ...
        CreateMap<DTO_CreateShop, SafeCommerce.DataAccessLayer.Models.Shop>()
            .ForMember(dest => dest.OwnerId, opt => opt.Ignore())
            .ForMember(dest => dest.EncryptedKey, opt => opt.MapFrom(src => src.EncryptedSymmetricKey));

        CreateMap<DTO_UpdateShop, SafeCommerce.DataAccessLayer.Models.Shop>()
            .ForMember(dest => dest.OwnerId, opt => opt.Ignore());
    }
}